...
- Extract: **company name**, **role title**, **department** (if mentioned), **location**, and **language** of the posting (German or English).
...
- **Match the language of the job posting** (German posting -> German cover letter, English posting -> English cover letter)
